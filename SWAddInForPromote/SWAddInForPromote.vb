...
Public Class SWAddInForPromote
    ...
    Sub MainProgram(ByVal poCmd As IEnoCmd, ByVal listOfComponents As IEnoSelection, ByVal listOfAssembly As IEnoSelection, ByVal listOfDrawings As IEnoSelection)
        ...
        For Each item In listOfDrawings
            ...
            boolstatus = swApp.RunMacro2("C:\Program Files\SolidWorks Corp 2017\swAddInForCheckIn\PDFDXFMacro_Alt.swp", "Personal11", "main", swRunMacroOption_e.swRunMacroUnloadAfterRun, iErrors)
